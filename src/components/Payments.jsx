...
const Payment = () => {
    ...
    return (
      <div className="bg-black min-h-screen p-7">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
          {/* Header */}
          <div>
            <h1 className="text-2xl font-bold text-blue-800 mt-2">Dollars</h1>
            <p className="text-sm text-blue-500 mt-1">
              This page show you Dollars information
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-between border rounded-lg p-4 mt-2">
                <div>
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-sm text-blue-600">Payment yearly</span>
                  </div>
                  <p className="text-lg font-bold text-blue-800 mt-1">${totalPayments.toFixed(2)} USD</p>
                  <p className="text-sm text-blue-500 mt-1">
                    (next renew 15 JAN 2025)
                  </p>
                </div>
                <div>
            ...
            <div>
              <h2 className="text-lg font-semibold text-blue-700">Payment Method</h2>
                ...
                <div>
                  <div className="flex items-center">
                    <img
                      ...
                      className="w-8 h-8"
                    />
                    <p className="ml-3 text-blue-800 font-medium">VistaHostel@edge.com</p>
                  </div>
                  <p className="text-sm text-blue-500 mt-1">Expiry 08/2025</p>
                </div>
                <button className="text-blue-600 font-medium text-sm hover:underline">
                  Change
                </button>
              ...
              <p className="text-sm text-blue-500 mt-2">
                Notes: Please be careful on choosing your payment method.
          ...
          <div className="mt-8">
            <h2 className="text-lg font-semibold text-gray-700">Payment ({numberOfPayments})</h2>
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="min-w-full bg-white border rounded-lg">
                <thead>
                  <tr className="bg-red-300 border-b">
                    <th className="text-left py-3 px-4 text-sm font-medium text-blue-600">
                      Payment Invoice
                    </th>
                    <th className="text-left py-3 px-4 text-sm font-medium text-blue-600">
                     Dollars
