...
const RoomForm = () => {
  ...
  return (
    <>
       <h2 className="text-2xl font-semibold text-red-800 mb-4 uppercase text-center">
        Add Room
      </h2>
    
      <form
        className="font-[sans-serif] text-red-800 max-w-4xl px-6 my-6 mx-auto"
      ...
      >
        <div className="grid sm:grid-cols-2 gap-10">
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder="eg.any Number"
              required
              className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-red-100 focus:border-red-800 outline-none"
            />
          </div>
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder="eg.more than 2 or 3"
              className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-red-100 focus:border-red-800 outline-none"
            />
          </div>
        ...
        <button
          type="submit"
          className="mt-10 w-fit px-6 py-2.5 rounded-lg text-sm bg-red-800 hover:bg-red-900 text-white"
        >
          Submit
        </button>
        </div>
